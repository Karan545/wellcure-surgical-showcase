...
import { anaesthesiaProductDetails, AnaesthesiaProductDetail } from "@/data/anaesthesia-product-details";
...
const ProductDetailsDialog = ({ isOpen, onClose, productTitle }: ProductDetailsDialogProps) => {
  const productDetail: AnaesthesiaProductDetail | undefined = anaesthesiaProductDetails[productTitle];
